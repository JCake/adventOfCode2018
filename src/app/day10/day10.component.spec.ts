...
fdescribe('Day10Component', () => {
  ...
  it('should find hidden message', () => {
    expect(component.showMessge(`position=< 9,  1> velocity=< 0,  2>
    ...
    position=<-3,  6> velocity=< 2, -1>`)).toBeTruthy();
  });

  it('should find word from real puzzle', () => {
    expect(component.showMessge(`position=<-32494,  54541> velocity=< 3, -5>
    ...
    position=<-32486, -10746> velocity=< 3,  1>`)).toBeTruthy();
  })
});
